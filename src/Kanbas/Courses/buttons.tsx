...
import { FaRegCheckCircle, FaEllipsisV, FaCaretDown} from "react-icons/fa";
function Buttons(){
return(
  <div className='d-none d-md-block'>
    ...
    <Dropdown>
        <Button variant="outline-secondary" style={{color:'black'}}><FaRegCheckCircle style={{paddingRight:'2px'}}/>Publish All  
        </Button>
        <Dropdown.Toggle variant="outline-secondary" as={Button} id="dropdown-basic">
            <FaCaretDown/>
          </Dropdown.Toggle>
        <Dropdown.Menu>
